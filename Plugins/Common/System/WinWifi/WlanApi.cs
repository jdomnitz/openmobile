...
namespace NativeWifi
{
    ...
    /// of this class.
    /// </remarks>
    public sealed class WlanClient
    {
        /// <summary>
        ...
        public class WlanInterface
        {
            ...
            public Wlan.WlanConnectionAttributes CurrentConnection
            {
                get
                {
                    ...
                    IntPtr valuePtr;
                    Wlan.WlanOpcodeValueType opcodeValueType;
                        Wlan.ThrowIfError(Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid, Wlan.WlanIntfOpcode.CurrentConnection, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
            ...
            {
                return (Wlan.WlanDisconnect(client.clientHandle, info.interfaceGuid, IntPtr.Zero) == 0);
            }
            /// <summary>
            ...
            {
                string XMLUserData = string.Format(WinWifi.Properties.Resources.String1, username, password);
                Wlan.ThrowIfError(
