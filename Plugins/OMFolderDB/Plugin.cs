    ...
    public sealed class Plugin:IMediaDatabase
    {
        ...
        private void processFile(string filepath)
        {
            ...
            lock (bCon)
            {
                ...
                DirectoryInfo di=new DirectoryInfo(filepath).Parent;
                info.Name = System.IO.Path.GetFileNameWithoutExtension(filepath);
                info.Album = di.Name;
                info.Artist = di.Parent.Name;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (info.coverArt == null)
                            info.coverArt = TagReader.getInfo(info.Location).coverArt;
                        if (info.coverArt == null)
