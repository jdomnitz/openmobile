...
namespace TagLib.Id3v2 {
	...
	public class TextInformationFrame : Frame
	{
		...
		/// </summary>
		/// <param name="ident">
		///    A ByteVector object containing an ID3v2.4
		///    frame identifier.
		/// </param>
		/// <param name="encoding">
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object starting with the
		///    frame to read.
		/// </param>
		/// <param name="version">
		...
		/// </summary>
		/// <value>
		///    A string[] containing the text contained
...
#region Constructors
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object starting with the raw
