...
#region Private Fields
		...
		/// <summary>
		///    Adds the contents of a string[] to the
		...
		/// <summary>
		///    Stores the contents of a string[] in a
		///    specified item.
		/// </summary>
		/// <param name="key">
		///    A <see cref="string" /> object containing the key of the
		...
		/// </param>
		/// <param name="value">
		///    A string[] containing the text to store.
		/// </param>
		/// <remarks>
		///    If <paramref name="value" /> is <see langword="null" />
		///    or empty, the value will be cleared.
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object containing the content
