...
namespace TagLib {
	...
	///    a collection of ByteVector objects.
	/// </summary>
	[ComVisible(false)]
	public class ByteVectorCollection : ListBase<ByteVector>
	{
		...
		///   /> containing ByteVector objects to add to
		...
		/// </summary>
		/// <param name="list">
		///   A ByteVector[] containing objects to add to
		///   the current instance.
		/// </param>
		...
		/// <summary>
		///    Performs a sorted insert of a ByteVector
		///    object into the current instance, optionally only adding
		///    if the item is unique.
		/// </summary>
		/// <param name="item">
		///    A ByteVector object to add to the current
		///    instance.
		/// </param>
		/// <param name="unique">
		...
		/// <summary>
		///    Splits a ByteVector object using a
		///    pattern.
		/// </summary>
		/// <param name="vector">
