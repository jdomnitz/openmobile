...
namespace TagLib.Asf {
	...
	public class Tag : TagLib.Tag, IEnumerable<ContentDescriptor>
	{
		...
		/// </summary>
		/// <param name="names">
		///    A string[] containing the names of the
		...
		/// </param>
		/// <param name="names">
		///    A string[] containing the names in which
		...
		/// </summary>
		/// <param name="value">
		///    A string[] containing the value to store,
		...
		///    A ContentDescriptor[] containing
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object containing raw ASF
		///    picture data.
		/// </param>
		/// <returns>
		...
		/// </param>
		/// <returns>
		///    A string[] containing the split text.
		/// </returns>
