...
#region Constructors
		...
		///    list stored in a ByteVector object.
		/// </summary>
		/// <param name="data">
...
#region Public Methods
		...
		/// <summary>
		///    Sets the value for a specified item in the current
		///    instance to the contents of a ByteVector[]
		/// </summary>
		/// <param name="id">
		///    A ByteVector object containing the ID of
		///    the item to set.
		/// </param>
		/// <param name="values">
		///    A ByteVector[] containing the values to
		///    store in the specified item.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="id" /> is <see langword="null" />.
		...
		/// <summary>
		///    Sets the value for a specified item in the current
		///    instance to the contents of a string[].
		/// </summary>
		/// <param name="id">
		///    A ByteVector object containing the ID of
		///    the item to set.
...
#region Private Methods
		...
		///    of a raw RIFF list stored in a ByteVector
		///    object.
		/// </summary>
		/// <param name="data">
		///    A <see cref="ByteVector"/> containing a raw RIFF list to
