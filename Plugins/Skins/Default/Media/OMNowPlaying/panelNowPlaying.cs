...
namespace OMMusicSkin
{
    internal class panelNowPlaying
    {
        ...
        public panelNowPlaying(HighLevelCode mainPlugin)
        {
        ...
        public OMPanel Initialize()
        {
            ...
            */
            ...
            btnGotoPlaylist.OnClick += (OMControl sender, int screen) => _MainPlugin.GotoPanel(screen, panelPlaylistView.PanelName);
            ...
            PopUpMenuStrip.Buttons.Add(Button.CreateMenuItem("mnuItem_Playlist", OM.Host.UIHandler.PopUpMenu.ButtonSize, 255, OM.Host.getSkinImage("AIcons|4-collections-view-as-grid"), "Current playlist", true, cmdOnClick: "Screen{:S:}.Panel.Goto.OMNowPlaying.Playlist"));
