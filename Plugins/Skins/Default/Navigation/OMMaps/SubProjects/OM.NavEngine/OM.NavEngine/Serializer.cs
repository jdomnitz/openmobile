...
namespace System.IO.XML
{
    ...
    public static class Serializer<T> where T : class // Specify that T must be a class.
    {
        ...
        public static T fromXML(string XML, System.Type[] extraTypes)
        {
            T serializableObject = null;
        ...
        private static TextReader CreateTextReader(IsolatedStorageFile isolatedStorageFolder, string path)
        {
            ...
            if (isolatedStorageFolder == null)
                ...
                textReader = new StreamReader(new IsolatedStorageFileStream(path, FileMode.Open, isolatedStorageFolder), System.Text.UTF8Encoding.Unicode);
        ...
        private static TextWriter CreateTextWriter(IsolatedStorageFile isolatedStorageFolder, string path)
        {
            ...
            if (isolatedStorageFolder == null)
                ...
                textWriter = new StreamWriter(new IsolatedStorageFileStream(path, FileMode.OpenOrCreate, isolatedStorageFolder), System.Text.UTF8Encoding.Unicode);
        ...
        public static string toXML(T serializableObject, System.Type[] extraTypes)
        {
            StringWriter textWriter = new StringWriter();
            XmlSerializer xmlSerializer = CreateXmlSerializer(extraTypes);
            xmlSerializer.Serialize(textWriter, serializableObject);
