        ...
        public IntPtr Display
        {
            get
            {
                if (_display == IntPtr.Zero)
                    throw new InvalidOperationException("Internal error (XLockDisplay with IntPtr.Zero). Please report this at http://www.OpenMobile.com/node/add/project-issue/OpenMobile");
                return _display;
            }
            set
            {
