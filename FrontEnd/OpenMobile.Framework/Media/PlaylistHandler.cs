...
namespace OpenMobile.Media
{
    ...
    public class PlayList
    {
        ...
        /// <summary>
        /// Currently active index in the list
        /// </summary>
        ...
        /// <summary>
        /// Gets the currently active mediaInfo item
        /// </summary>
        ...
        private void GenerateQueue(bool ClearQueue)
        {
            ...
            if (ItemsToAdd >= (_Items.Count - _QueuedItems.Count))
            {
                ItemsToAdd = _Items.Count - 1;
                _QueuedItems.Clear();
            }
            ...
            for (int i = 0; i < ItemsToAdd; i++)
            {
                ...
                {   // Random playback
                    int NewIndex;
                    do
                        NewIndex = OpenMobile.Framework.Math.Calculation.RandomNumber(0, _Items.Count);
                    while (_QueuedItems.Contains(NewIndex));
                ...
                else
                {
                    // Sequencial playback
                    int NewIndex = 0;
                    if (_QueuedItems != null && _QueuedItems.Count > 0)
                        NewIndex = _QueuedItems.First.Value + _QueuedItems.Count;
                    else
                        NewIndex = i + 1;
    ...
    public class PlaylistHandler
    {
        ...
        public static bool writePlaylistToDB(string name, List<mediaInfo> playlist)
        {
            ...
            using (PluginSettings s = new PluginSettings())
                BuiltInComponents.Host.getData(eGetData.GetMediaDatabase, s.getSetting("Default.MusicDatabase"), out o);
            if (o == null)
                return false;
