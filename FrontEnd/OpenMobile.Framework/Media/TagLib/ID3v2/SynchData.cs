...
namespace TagLib.Id3v2 {
	...
	public static class SynchData
	{
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object containing the number
		...
		/// </param>
		/// <returns>
		///    A ByteVector object containing the encoded
		///    number.
		/// </returns>
		...
		/// <summary>
		///    Unsynchronizes a ByteVector object by
		///    inserting empty bytes where necessary.
		/// </summary>
		/// <param name="data">
		///    A ByteVector object to unsynchronize.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="data" /> is <see langword="null" />.
		/// </exception>
		...
		/// <summary>
		///    Resynchronizes a ByteVector object by
		///    removing the added bytes.
		/// </summary>
		/// <param name="data">
		///    A ByteVector object to resynchronize.
		/// </param>
		/// <exception cref="ArgumentNullException">
		///    <paramref name="data" /> is <see langword="null" />.
		/// </exception>
