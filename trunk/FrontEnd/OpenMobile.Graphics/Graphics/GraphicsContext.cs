...
namespace OpenMobile.Graphics
{
    ...
    public sealed class GraphicsContext : IGraphicsContext, IGraphicsContextInternal
    {
        ...
        public GraphicsContext(GraphicsMode mode, IWindowInfo window)
            : this(mode, window, 2, 0, GraphicsContextFlags.Default)
        { }
        ...
        /// Influences the debug version of OpenMobile.dll, only.
        /// </summary>
        ...
        /// <remarks>
        /// <para>
        /// Direct rendering is the default rendering mode for OpenMobile, since it can provide higher performance
        ...
        /// </summary>
        /// <param name="window">A valid <see cref="OpenMobile.Platform.IWindowInfo" /> structure.</param>
        /// <remarks>
        ...
        /// </summary>
        /// <exception cref="OpenMobile.Graphics.GraphicsContextException">
