    ...
    internal class WinDisplayDeviceDriver : IDisplayDeviceDriver
    {
        ...
        static WinDisplayDeviceDriver()
        {
            lock (display_lock)
            {
                ...
                bool OpenMobile_dev_primary = false;
                ...
                while (Functions.EnumDisplayDevices(null, device_count++, dev1, 0))
                {
                    ...
                    {
                        OpenMobile_dev_current_res = new DisplayResolution(
                    ...
                    while (Functions.EnumDisplaySettings(dev1.DeviceName.ToString(), mode_count++, monitor_mode))
                    {
                        ...
                        OpenMobile_dev_available_res.Add(res);
                    }

                    // Construct the OpenMobile DisplayDevice through the accumulated parameters.
                    // The constructor will automatically add the DisplayDevice to the list
                    // of available devices.
                    OpenMobile_dev = new DisplayDevice(
                        OpenMobile_dev_current_res,
                        OpenMobile_dev_primary,
                        OpenMobile_dev_available_res,
                        OpenMobile_dev_current_res.Bounds);

                    available_device_names.Add(OpenMobile_dev, dev1.DeviceName);
                }
            }
        }
        ...
        #region public bool TryChangeResolution(OpenMobile.Graphics.DisplayDevice device, DisplayResolution resolution)
        ...
        #region public TryRestoreResolution TryRestoreResolution(OpenMobile.Graphics.DisplayDevice device)
