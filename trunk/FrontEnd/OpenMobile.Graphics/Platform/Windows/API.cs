...
namespace OpenMobile.Platform.Windows
{
    ...
    /// \internal
    /// <summary>
    /// For internal use by OpenMobile only!
    ...
    public static class Functions
    {
        ...
        */
        ...
        public static extern BOOL GetWindowInfo(HWND hwnd, ref WindowInfo wi);
        ...
        /// before calling GetRawInputDeviceInfo. (This is done automatically in OpenMobile)
        /// </param>
        /// <param name="Size">
    ...
    */
    ...
    {
        public Win32Rectangle(int width, int height)
        {
            left = top = 0;
            right = width;
            bottom = height;
