...
namespace OpenMobile.Platform.MacOS.Carbon
{
    ...
    internal partial class API
    {
        ...
        [DllImport(carbon, EntryPoint = "CreateCGContextForPort")]
        internal static extern OSStatus CreateCGContextForPort(IntPtr port, out IntPtr context);

        [DllImport(carbon, EntryPoint = "CGContextSetAlpha")]
        internal static extern void CGContextSetAlpha(IntPtr context, float alpha);

        [DllImport(carbon, EntryPoint = "CGContextFlush")]
