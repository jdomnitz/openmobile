...
namespace OpenMobile.Platform
{
    ...
    public static class Utilities
    {
        ...
        [Obsolete("Call new OpenMobile.Graphics.GraphicsContext() directly, instead.")]
        ...
        {
            Platform.X11.X11WindowInfo window = new OpenMobile.Platform.X11.X11WindowInfo();
        ...
        {
            return new OpenMobile.Platform.Windows.WinWindowInfo(windowHandle, null);
        }
        ...
        {
            return new OpenMobile.Platform.MacOS.CarbonWindowInfo(windowHandle, false, isControl);
        }
