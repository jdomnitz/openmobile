...
namespace OpenMobile.Controls
{
    ...
    /// </summary>
    public class OMObjectList2 : OMContainer, IMousePreview
    {
        #region Preconfigured controls

        public static OMObjectList2 PreConfigLayout_ImageFlow(string name, int left, int top, int width, int height, Size itemSize, int overlap)
        {
            OMObjectList2 list = new OMObjectList2(name, left, top, width, height);
        ...
        /// List item
        /// </summary>
        public class ListControlItem : ControlGroup
        {
            /// <summary>
            ...
            internal void ExecuteAction_Select(OMObjectList2 sender, int screen, int myIndex)
            {
            ...
            internal void ExecuteAction_Deselect(OMObjectList2 sender, int screen, int myIndex)
            {
                this.myIndex = myIndex;
                SetControlName(myIndex);
            ...
            internal void ExecuteAction_Highlight(OMObjectList2 sender, int screen, int myIndex)
            {
                this.myIndex = myIndex;
                SetControlName(myIndex);
            ...
            internal void ExecuteAction_Unhighlight(OMObjectList2 sender, int screen, int myIndex)
            {
                this.myIndex = myIndex;
                SetControlName(myIndex);
            ...
            internal void ExecuteAction_SetValues(OMObjectList2 sender, int screen, int myIndex, object[] values)
            {
                this.myIndex = myIndex;
                SetControlName(myIndex);
            ...
            /// </summary>
            /// <returns></returns>
            public ListControlItem Clone()
            {
                ListControlItem newListItem = new ListControlItem();
        ...
        public delegate void IndexChangedDelegate(OMObjectList2 sender, int screen);
        /// <summary>
        ...
        private ListControlItem _ItemBase = null;
        /// <summary>
        /// Set info
        /// </summary>
        /// <param name="sender"></param>
        ...
        public delegate void SetItemInfoDelegate(OMObjectList2 sender, int screen, ListControlItem item, object[] values);
        /// <summary>
        /// Item action
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="screen"></param>
        /// <param name="item"></param>
        public delegate void ItemActionDelegate(OMObjectList2 sender, int screen, ListControlItem item);
        ...
        //private List<object[]> _

        //Create new List control that can handle list items in memory and only display what can fit on screen
        ...
        /// Index of the selected item
        /// </summary>
        public ListControlItem HighlightedItem
        {
            get
            {
        ...
        /// </summary>
        public ListControlItem ItemBase
        {
            get
            {
                return _ItemBase;
        ...
        {
            if (this.parent == null)
                throw new Exception("OMObjectList2 needs a valid parent. Ensure the control is added to a panel before adding items to it");

            ListControlItem listItem = null;
        ...
        /// <param name="direction"></param>
        /// <param name="values"></param>
        public void AddItem(ListControlItem baseItem, ControlDirections direction, params object[] values)
        {
        ...
        /// <param name="values"></param>
        /// <param name="direction"></param>
        public void AddItem(ListControlItem baseItem, object[] values, ControlDirections direction)
        {
            if (this.parent == null)
                throw new Exception("OMObjectList2 needs a valid parent. Ensure the control is added to a panel before adding items to it");
        ...
        {
            OMObjectList2 newList = (OMObjectList2)base.Clone(parent);
            newList._Items = this._Items.ConvertAll(x => (ListControlItem)x.Clone());
            return newList;
        }
        ...
        [Obsolete("This method is not supported in the OMObjectList2 control", true)]
