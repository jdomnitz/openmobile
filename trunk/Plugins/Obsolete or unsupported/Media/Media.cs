...
namespace Media
{
    public sealed class Media : IHighLevel
    {
        ...
        public eLoadStatus initialize(IPluginHost host)
        {
            ...
            artists.Font = new Font(Font.GenericSansSerif, 26F);
		    ...
		    Title.Font= new Font(Font.GenericCursive,48F);
		    ...
		    chkIndex.Font= new Font(Font.GenericSansSerif,31F);
            ...
            pathCaption.Font = new Font(Font.GenericSansSerif, 32F);
		    pathCaption.Top=270;
            ...
            path.Font = new Font(Font.GenericSansSerif, 32.25F);
