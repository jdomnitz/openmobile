...
namespace TagLib {
	...
	public abstract class File
	{
		...
		/// </param>
		/// <remarks>
		///    In order to remove all tags from a file, pass
		///    TagTypes.AllTags as <paramref name="types" />.
		/// </remarks>
		...
		/// </param>
		/// <returns>
		///    A ByteVector object containing the data
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object containing data to be
		...
		/// </summary>
		/// <param name="pattern">
		///    A ByteVector object containing a pattern
		...
		/// </param>
		/// <param name="before">
		///    A ByteVector object specifying a pattern
		...
		/// </summary>
		/// <param name="data">
		///    A ByteVector object containing the data to
