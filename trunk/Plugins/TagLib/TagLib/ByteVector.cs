...
#region Constructors
		...
		/// </summary>
		/// <param name="vector">
		///    A ByteVector object containing the bytes
		...
		///    ByteVector by copying the values from a
		///    specified byte[].
		/// </summary>
		/// <param name="data">
		///    A byte[] containing the bytes to be stored
		///    in the new instance.
		/// </param>
		...
		/// </summary>
		/// <value>
		///    A byte[] containing the data stored in the
		///    current instance.
		/// </value>
		public byte [] Data {
...
#region Public Methods
		...
		/// <summary>
		///    Adds the contents of another ByteVector
		...
		/// </summary>
		/// <param name="data">
		///    A byte[] containing data to add to the end
		///    of the current instance.
		/// </param>
		/// <exception cref="NotSupportedException">
		///    The current instance is read-only.
		...
		/// <summary>
		///    Inserts the contents of another ByteVector
		...
		/// </param>
		/// <param name="data">
		///    A byte[] containing data to insert into the
		///    current instance.
		/// </param>
		/// <exception cref="NotSupportedException">
		///    The current instance is read-only.
...
#region Operators
		...
		/// <summary>
		///    Determines whether or not one ByteVector
		...
		/// </param>
		/// <returns>
		///    A new instance of ByteVector with the
		...
		/// </param>
		/// <returns>
		///    A new instance of ByteVector containing
		///    <paramref name="value" />.
		/// </returns>
...
#region Static Conversions
		...
		///    A byte[] reference to be filled with the
...
#region IComparable<T>
		...
		/// </summary>
		/// <param name="other">
		///    A ByteVector object to compare to the
		///    current instance.
		/// </param>
		/// <returns>
...
#region ICollection<T>
		...
		/// <summary>
		///    Copies the current instance to a byte[]
