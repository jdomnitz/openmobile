...
namespace TagLib.Mpeg4 {
	...
	public class AppleTag : TagLib.Tag, IEnumerable<Box>
	{
		...
		/// </summary>
		/// <param name="types">
		///    A ByteVector[] containing list of box
		///    types to match.
		/// </param>
		/// <returns>
		///    A <see cref="T:System.Collections.Generic.IEnumerable`1" /> object enumerating the
		...
		/// </summary>
		/// <param name="type">
		///    A ByteVector object containing the box
		///    type to match.
		/// </param>
		/// <returns>
		///    A string[] containing text from all
		///    matching boxes.
		/// </returns>
		...
		/// </summary>
		/// <param name="type">
		///    A ByteVector object containing the type to
		///    add to the new instance.
		/// </param>
		/// <param name="boxes">
		///    A AppleDataBox[] containing boxes to add
		...
		/// </param>
		/// <param name="data">
		///    A ByteVector object containing data to add
		///    for the specified type.
		/// </param>
		/// <param name="flags">
		///    A <see cref="uint" /> value containing flags to use for
		...
		/// </param>
		/// <param name="text">
		///    A string[] containing text to store.
		/// </param>
		...
		/// </summary>
		/// <param name="type">
		///    A ByteVector object containing the type of
		...
		/// </summary>
		/// <param name="id">
		///    A ByteVector object containing an ID to
		///    fix.
		/// </param>
		/// <returns>
