...
namespace OMMapProvider
{
    public sealed class OMMapProvider : BasePluginCode, IDataSource
    {
        ...
        void Datasources_Register()
        {
            ...
            OM.Host.DataHandler.AddDataSource(true, new DataSource(this, "Map", "Show", "MapPlugin", 0, DataSource.DataTypes.raw, null, "True indicates that the map panel should be shown"), true);
        }
        ...
        void Commands_Register()
        {
            ...
            OM.Host.CommandHandler.AddCommand(true, new Command(this, "Map", "Zoom", "Level", CommandExecutor, 1, false, "Set's the current zoom level of the map (0 (no zoom) - 17 (max zoom))"));
            ...
            OM.Host.CommandHandler.AddCommand(true, new Command(this, "Map", "Marker", "ZoomAll", CommandExecutor, 0, false, "Zoomes out or in to show all markers on the map. Param0: OwnerPluginName"));
                ...
                case "Map.Goto.Current":
                    {
                        ...
                        _Map[command.Screen].Zoom = CalculateZoomLevel();
                    }
                    break;
                        ...
                        OM.Host.ForEachScreen((screen) =>
                            {
                                if (_Map_FollowsCurrentLoc[screen])
                                {
                                    ...
                                    _Map[screen].Zoom = CalculateZoomLevel();
                                }
                            });
                    }
                    break;
        ...
        void Map_OnImageAssigned(object sender, GMapImageUpdatedEventArgs e)
        {
            ...
            _MapImage[screen] = new OImage(map.TargetImage);
