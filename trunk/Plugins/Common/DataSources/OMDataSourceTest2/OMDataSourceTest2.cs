...
namespace OMDataSourceTest2
{
    public sealed class OMDataSourceTest2 : BasePluginCode, IDataSource
    {
        public OMDataSourceTest2()
            : base("OMDataSourceTest2", OM.Host.getSkinImage("Icons|Icon-DataSource"), 1f, "A sample plugin for a datasource", "OM Dev team", "")
        {
        }
